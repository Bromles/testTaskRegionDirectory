...
_Примечание: При отсутствии обращений в течение значительного периода времени приложение уходит в сон, что может привести к провалу первого запроса. 
В таком случае достаточно продублировать запрос (в случае захода через браузер — обновить страницу), чтобы его получило уже проснувшееся приложение_
...
В качестве идентификаторов были использованы реальные коды субъектов РФ
