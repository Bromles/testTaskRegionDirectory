...
public interface IRegionDirectoryService {
     ...
     *
     * @param regionDTO Тип: RegionDTO. Объект трансфера данных, на основе которого генерируется сущность для
     ...
     *
     * @param id Тип: String. Идентификатор региона, по которому осуществляется поиск в репозитории
     ...
     *
     * @param name Тип: String. Наименование региона, по которому осуществляется поиск в репозитории
     ...
     *
     * @param nameBeginning Тип: String. Начало наименования региона, по которому осуществляется поиск в репозитории
     ...
     *
     * @param shortName Тип: String. Сокращенное наименование региона, по которому осуществляется поиск в репозитории
     * @return Возвращает список объектов трансфера данных, сгенерированный на основе списка регионов с данным
     ...
     * @param regionDTO Тип: RegionDTO. Объект трансфера данных, на основе которого генерируется сущность, заменяющая
     ...
     *
     * @param id Тип: String. Идентификатор, по которому осуществляется поиск региона в репозитории для удаления
     * @throws RecordNotFoundException Исключение, генерируемое при отсутствии в репозитории региона с данным
     *                                 идентификатором
     */
